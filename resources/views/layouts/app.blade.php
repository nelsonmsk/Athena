...
<head>
   ...
   <meta charset="utf-8">
	...
	<link rel="stylesheet" href="{{ asset('css/fancy-buttons.css') }}" />
	<link rel="stylesheet" href="{{ asset('css/animate.css') }}" />
    <link rel="stylesheet" href="{{ asset('css/fontawesome-all.min.css') }}">
    <link rel="stylesheet" href="{{ asset('css/font-awesome.min.css') }}">		
	<link rel="stylesheet" href="{{ asset('css/jquery.vegas.css') }}" />
	<link rel="stylesheet" href="{{ asset('css/baraja.css') }}" />
	...
	<link rel="stylesheet" href="{{ asset('css/schemes/red.css') }}" disabled />
	<link rel="stylesheet" id="scheme-source" href="{{ asset('css/schemes/orange.css') }}" />
	<link rel="stylesheet" href="{{ asset('css/schemes/gray.css') }}" disabled />	
	<link rel="stylesheet" href="{{ asset('css/schemes/blue.css') }}" disabled />	
